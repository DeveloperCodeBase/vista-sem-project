export default function StatsHighlights() {
  const stats = [
    { value: "۱۴ سامانه", label: "برنامه در حال بهره‌برداری" },
    { value: "۲۱ استان", label: "پوشش عملیاتی و مشاوره" },
    { value: "۳۲ میلیارد ریال", label: "صرفه‌جویی سالانه مستند" },
    { value: "ISO 27001", label: "حاکمیت داده و امنیت" }
  ];
