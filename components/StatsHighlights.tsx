export default function StatsHighlights() {
  const stats = [
    { value: "۱۳ برنامه", label: "پرونده‌های فعال استان سمنان" },
    { value: "۱ استان", label: "تمرکز و استقرار محلی" },
    { value: "۲۴/۷", label: "پشتیبانی عملیات و مانیتورینگ" },
    { value: "پارک علم و فناوری", label: "واحد فناور مستقر در سمنان" }
  ];
